...
<!--In this section you explain what you are trying to show.  Where did the data come from?  What is the research or other question you are trying to answer?!-->
 The cabbages data from the MASS package is loaded into a dataframe called veggy. Complete this report by answering the following two question. 
 
Is there a difference in average VitC between c39 and c52 cultivation methods?  

$H_0$: There is no difference in the average Vitamin C content of cabbages based on cultivation methods (c39 and c52). 
...
```
The p-value is 0.00000005 is less than   0.05, we reject the null hypothesis.
...
The relationship between C39 and C52 is not equal to 0 there is a difference in the average content of cabbages. The cultivation is categorical. The mean for C39 is 51.5 and the mean in group C52 is 64.4.
